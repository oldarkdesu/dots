...
- My Bash configuration (at `pkgs/bash`). I have it separated into multiple files, with the sourced `prompt.sh` being the one I'm most proud of. It uses `git-prompt.sh` from Arch's oficial Git package to print the git repo status.
